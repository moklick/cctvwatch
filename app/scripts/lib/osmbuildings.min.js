...
case "cone":z.draw(a,e.center.x-t,e.center.y-q,e.radius,0,d,f,u,r);break;case "dome":z.draw(a,e.center.x-t,e.center.y-q,e.radius,e.radius/2,d,f,u,r);break;default:p=this.drawSolid(p,g,h,u,r);m=[];if(e.holes){d=0;for(f=e.holes.length;d<f;d++)m[d]=this.drawSolid(e.holes[d],g,h,u,r)}a.fillStyle=s;this.drawFace(p,!0,m)}}}}},va={maxZoom:K+2,maxHeight:2,isSimple:function(a){return D<=this.maxZoom&&a.height+a.roofHeight<this.maxHeight},getFace:function(a){for(var b=[],c=0,d=a.length-3;c<d;c+=2)b[c]=a[c]-
t,b[c+1]=a[c+1]-q;return b},drawFace:function(a,b){if(a.length){var c=this.context,d,f,e,g;c.beginPath();c.moveTo(a[0],a[1]);d=2;for(f=a.length;d<f;d+=2)c.lineTo(a[d],a[d+1]);if(b){d=0;for(f=b.length;d<f;d++){a=b[d];c.moveTo(a[0],a[1]);e=2;for(g=a.length;e<g;e+=2)c.lineTo(a[e],a[e+1])}}c.closePath();c.stroke();c.fill()}},render:function(){this.context.clearRect(0,0,C,y);if(!(D<K||aa||D>this.maxZoom)){var a,b,c,d,f,e=t,g=t+C,h=q,l=q+y,j,k,n,m=E.items;a=0;for(b=m.length;a<b;a++)if(f=m[a],!(f.height>=
this.maxHeight)){n=!1;j=f.footprint;c=0;for(d=j.length-1;c<d;c+=2)n||(n=j[c]>e&&j[c]<g&&j[c+1]>h&&j[c+1]<l);if(n)if(c=f.altColor||da,n=f.roofColor||Z,this.context.strokeStyle=c,"cylinder"===f.shape||"cone"===f.shape||"dome"===f.shape)z.circle(this.context,f.center.x-t,f.center.y-q,f.radius,n);else{j=this.getFace(j);k=[];if(f.holes){c=0;for(d=f.holes.length;c<d;c++)k[c]=this.getFace(f.holes[c])}this.context.fillStyle=n;this.drawFace(j,k)}}}}},N={enabled:!0,color:"#666666",blurColor:"#000000",blurSize:15,
date:new Date,direction:{x:0,y:0},project:function(a,b,c){return{x:a+this.direction.x*c,y:b+this.direction.y*c}},render:function(){var a=this.context,b,c,d;a.clearRect(0,0,C,y);if(this.enabled&&!(D<K||aa))if(b=ca(t+X,q+ka),b=Ja(this.date,b.latitude,b.longitude),!(0>=b.altitude)){c=1/Fa(b.altitude);d=5>c?0.75:5*(1/c);this.direction.x=Ca(b.azimuth)*c;this.direction.y=Ya(b.azimuth)*c;var f,e,g,h,l,j,k,n,m,p,r,u,s,x;b=[];c=[];var w=E.items;a.canvas.style.opacity=d/(2*A);a.shadowColor=this.blurColor;a.shadowBlur=
this.blurSize*(A/2);a.fillStyle=this.color;a.beginPath();d=0;for(f=w.length;d<f;d++){j=w[d];m=!1;k=j.footprint;h=[];e=0;for(g=k.length-1;e<g;e+=2)h[e]=l=k[e]-t,h[e+1]=n=k[e+1]-q,m||(m=0<l&&l<C&&0<n&&n<y);if(m)if(l=1>j.scale?j.height*j.scale:j.height,k=0,j.minHeight&&(k=1>j.scale?j.minHeight*j.scale:j.minHeight),"cylinder"===j.shape||"cone"===j.shape||"dome"===j.shape)b.push({shape:j.shape,center:{x:j.center.x-t,y:j.center.y-q},radius:j.radius,h:l,mh:k}),("cone"===j.roofShape||"dome"===j.roofShape)&&
b.push({shape:j.roofShape,center:{x:j.center.x-t,y:j.center.y-q},radius:j.radius,h:l+j.roofHeight,mh:l});else{n=null;e=0;for(g=h.length-3;e<g;e+=2)m=h[e],p=h[e+1],r=h[e+2],u=h[e+3],s=this.project(m,p,l),x=this.project(r,u,l),k&&(p=this.project(m,p,k),u=this.project(r,u,k),m=p.x,p=p.y,r=u.x,u=u.y),(r-m)*(s.y-p)>(s.x-m)*(u-p)?(1===n&&a.lineTo(m,p),n=0,e||a.moveTo(m,p),a.lineTo(r,u)):(0===n&&a.lineTo(s.x,s.y),n=1,e||a.moveTo(s.x,s.y),a.lineTo(x.x,x.y));k||c.push(h);if(j.holes){e=0;for(g=j.holes.length;e<
g;e++){n=j.holes[e];m=[n[0]-t,n[1]-q];a.moveTo(m[0],m[1]);h=2;for(l=n.length;h<l;h+=2)m[h]=n[h]-t,m[h+1]=n[h+1]-q,a.lineTo(m[h],m[h+1]);k||c.push(m)}}}}d=0;for(f=b.length;d<f;d++)switch(j=b[d],w=j.center.x,e=j.center.y,g=j.radius,j.shape){case "cylinder":z.shadow(a,w,e,g,g,j.h,j.mh);break;case "cone":z.shadow(a,w,e,g,0,j.h,j.mh);break;case "dome":z.shadow(a,w,e,g,g/2,j.h,j.mh)}a.closePath();a.fill();a.shadowBlur=null;a.globalCompositeOperation="destination-out";a.beginPath();d=0;for(f=c.length;d<
f;d++){n=c[d];a.moveTo(n[0],n[1]);e=2;for(g=n.length;e<g;e+=2)a.lineTo(n[e],n[e+1]);a.lineTo(n[0],n[1])}d=0;for(f=b.length;d<f;d++)j=b[d],("cylinder"===j.shape||"cone"===j.shape||"dome"===j.shape)&&!j.mh&&z.footprintMask(a,j.center.x,j.center.y,j.radius);a.fillStyle="#00ff00";a.fill();a.globalCompositeOperation="source-over"}}},s={container:oa.createElement("DIV"),items:[],init:function(){this.container.style.pointerEvents="none";this.container.style.position="absolute";this.container.style.left=
0;this.container.style.top=0;N.context=this.createContext();va.context=this.createContext();ba.context=this.createContext()},render:function(){N.render();va.render();ba.render()},createContext:function(){var a=oa.createElement("CANVAS");a.style.webkitTransform="translate3d(0,0,0)";a.style.imageRendering="optimizeSpeed";a.style.position="absolute";a.style.left=0;a.style.top=0;var b=a.getContext("2d");b.lineCap="round";b.lineJoin="round";b.lineWidth=1;b.mozImageSmoothingEnabled=!1;b.webkitImageSmoothingEnabled=
!1;this.items.push(a);this.container.appendChild(a);return b},appendTo:function(a){a.appendChild(this.container)},remove:function(){this.container.parentNode.removeChild(this.container)},setSize:function(a,b){for(var c=0,d=this.items.length;c<d;c++)this.items[c].width=a,this.items[c].height=b},screenshot:function(){var a=oa.createElement("CANVAS"),b=a.getContext("2d"),c,d,f;a.width=C;a.height=y;clearInterval(S);S=null;f=E.items;c=0;for(d=f.length;c<d;c++)f[c].scale=1;this.render();c=0;for(d=this.items.length;c<
d;c++)f=this.items[c],""!==f.style.opacity&&(b.globalAlpha=parseFloat(f.style.opacity)),b.drawImage(f,0,0),b.globalAlpha=1;return a.toDataURL("image/png")},setPosition:function(a,b){this.container.style.left=a+"px";this.container.style.top=b+"px"}};s.init();var m=function(a){this.offset={x:0,y:0};a.addLayer(this)},r=m.prototype;r.onAdd=function(a){this.map=a;s.appendTo(a._panes.overlayPane);var b=this.getOffset(),c=a.getPixelOrigin();za({w:a._size.x,h:a._size.y});var d=c.y-b.y;t=c.x-b.x;q=d;Aa(a._zoom);
s.setPosition(-b.x,-b.y);a.on({move:this.onMove,moveend:this.onMoveEnd,zoomstart:this.onZoomStart,zoomend:this.onZoomEnd,resize:this.onResize,viewreset:this.onViewReset},this);if(a.options.zoomAnimation)a.on("zoomanim",this.onZoom,this);a.attributionControl&&a.attributionControl.addAttribution('&copy; <a href="http://osmbuildings.org">OSM Buildings</a>');E.update()};r.onRemove=function(){var a=this.map;a.attributionControl&&a.attributionControl.removeAttribution('&copy; <a href="http://osmbuildings.org">OSM Buildings</a>');
